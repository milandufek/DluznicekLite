...
public class AddCurrencyOnClickListenerTest {
    ...
    public void currencyWithEmptyNameShowsWarning() {
        ...
        final Currency currencyWithEmptyName = new Currency(0, "", "b", 1, 1.0, 0, 0, 1);
        final AppCompatActivity activity = mock(AppCompatActivity.class);
        final AddCurrencyOnClickListener tested = new AddCurrencyOnClickListener(currencyWithEmptyName, activity);
        ...
        verify(spied).showText(eq(R.string.warrning_currency_empty));
    }
